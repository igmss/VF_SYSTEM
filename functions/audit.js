...
async function fullAudit() {
  ...
  console.log("Total Collector Cash:", collectorTotal);
  ...
  const netProfit = totalAssetsWithLoans - (openingCapital + totalInvestorCapital);
  console.log("Net Business Profit:", netProfit);
